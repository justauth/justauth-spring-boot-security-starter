...
CREATE TABLE `auth_token` (
  ...
  `unionId` varchar(64) DEFAULT NULL COMMENT 'QQ附带属性',
  `scope` varchar(64) DEFAULT NULL COMMENT 'Google附带属性',
  `tokenType` varchar(20) DEFAULT NULL COMMENT 'Google附带属性',
  `idToken` varchar(64) DEFAULT NULL COMMENT 'Google附带属性',
  `macAlgorithm` varchar(20) DEFAULT NULL COMMENT '小米附带属性',
  `macKey` varchar(64) DEFAULT NULL COMMENT '小米附带属性',
  `code` varchar(64) DEFAULT NULL COMMENT '企业微信附带属性',
  `oauthToken` varchar(64) DEFAULT NULL COMMENT 'Twitter附带属性',
  `oauthTokenSecret` varchar(64) DEFAULT NULL COMMENT 'Twitter附带属性',
