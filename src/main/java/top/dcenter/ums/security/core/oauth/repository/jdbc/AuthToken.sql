...
CREATE TABLE `auth_token` (
  ...
  `accessCode` varchar(512) DEFAULT NULL COMMENT 'dingTalk, taobao 附带属性',
  `unionId` varchar(512) DEFAULT NULL COMMENT 'QQ附带属性',
  `scope` varchar(255) DEFAULT NULL COMMENT 'Google附带属性',
  `tokenType` varchar(20) DEFAULT NULL COMMENT 'Google附带属性',
  `idToken` varchar(512) DEFAULT NULL COMMENT 'Google附带属性',
  `macAlgorithm` varchar(20) DEFAULT NULL COMMENT '小米附带属性',
  `macKey` varchar(512) DEFAULT NULL COMMENT '小米附带属性',
  `code` varchar(512) DEFAULT NULL COMMENT '企业微信附带属性',
  `oauthToken` varchar(512) DEFAULT NULL COMMENT 'Twitter附带属性',
  `oauthTokenSecret` varchar(512) DEFAULT NULL COMMENT 'Twitter附带属性',
